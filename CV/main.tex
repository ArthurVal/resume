...
% job title/career
\cvjobtitle{Expert C/C++/Python\\[0.2em] Contrôle \& Robotique}
...
\addtofrontsidebar{
  ...
  \begin{figure}\centering
    \smartdiagram[bubble diagram]{
      ...
      % --
      \textcolor{black!90}{\large \href{https://en.wikipedia.org/wiki/Test-driven_development}{TDD}}\\
      \textcolor{black!90}{\large \href{https://en.wikipedia.org/wiki/SOLID}{SOLID}},
      % --
