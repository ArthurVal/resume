...
\addtofrontsidebar{
	...
	\profilesection{Langues}
	  ...
	  \pointskill{\flag{JP.png}}{Japonais}{1}
  ...
  \profilesection{Compétences}
    \chartlabel{Aperçu}
  	\begin{figure}\centering
  		\smartdiagram[bubble diagram]{
  			...
  			\textcolor{black!90}{\large \ros, \ice}\\
  			\textcolor{black!90}{\large middleware}\\
  			\textcolor{black!90}{(TCP - UDP)},
    ...
    \chartlabel{Software}\\
  	\begin{figure}\centering    
      \barskill{}{\large C++ $\textbullet$ Python $\textbullet$ git $\textbullet$ \ros}{90}
      \barskill{}{\large Bash $\textbullet$ CMake $\textbullet$ Emacs}{80}
      \barskill{}{\large Matlab $\textbullet$ Simulink $\textbullet$ Make}{40}
      \barskill{}{\large \LaTeX }{20}
  	\end{figure}
}
