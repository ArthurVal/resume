...
% job title/career
\cvjobtitle{Ingénieur Logiciel\\[0.2em] Contrôle \& Robotique}
...
\addtofrontsidebar{
  ...
  \aboutme{
    \hl{Curieux}, j'aime apprendre/découvrir le fonctionnement des choses.
...
\begin{cvtable}[2]
  \cvitem{Octo 2022 -- Présent}{CDI : Ingénieur Dév. Logiciel Embarqué}
         {\href{https://fr.wikipedia.org/wiki/Airbus_Defence_and_Space}{Airbus DS, Toulouse}}
  {
    ...
    \href{https://nanoxplore.org/index.php/product/ng-ultra/}{NG-Ultra} (2x ARM
    R52 + FPGA)\newline
    $\bullet$ Spec/Développement sur divers projets (C et C++)
  }

  \cvitem{Juin 2021 -- Octo 2022}{CDI : Ingénieur Logiciel Contrôle Accélérateur}
      ...
      Polytechnique, Palaiseau}}
  {
    ...
    \hl{Spécification fonctionnelle} robot pour test automatique de détecteurs
    HGCROC. (\textbf{UML})
  }
  ...
  {\cea-DRF-IRFU, Saclay}
  {
    ...
    $\bullet$ Développement de l'infrastructure de test distribuée (2x
    \hl{Zedboard}, PC, plateforme embarqué ECLAIRs) (\textbf{C++},
    \textbf{Python})\newline
  ...
  {\cea-DRT-LIST, Saclay}
  {
    ...
    $\bullet$ \textbf{\href{https://www.designspot.fr/portfolio/face/}{Projet
        FACE}}: En charge de la \hl{création du prototype} de démonstration
    multi \href{https://en.wikipedia.org/wiki/System_on_a_chip}{System-On-Chip}
    distribué (Renesas R-Car H3, Nvidia Tx2, Kalray MPPA Bostan) pour le
    véhicule autonome\newline
    $\bullet$ Développement de 'layers' Linux embarqué \hl{Yocto} pour R-Car H3
  }
